...
# Load tickets
OD_tickets <- read.csv("Data/Processed/Seeds/OD_seeds_step3.csv", header=TRUE)
...
# load counter data 
train_count <- read.csv("Data/train.csv", colClasses = c(rep("character", 7), "numeric", rep("character", 3),rep("numeric", 2),"character"))
...
Coverage <- read.csv("Data/Processed/Marginals/coverage.csv")
...
Marg_partial <- read.csv("Data/Processed/Marginals/partial_marginals.csv")
...
Marg_filled <- read.csv("Data/Processed/Marginals/marginals_filled.csv")
...
#### Furness matrices  ----
# Load Furness
OD_Trenord <- read.csv("Data/Processed/IPF/OD_Trenord_IPF.csv")
...
#### Margins error ----
# Load errors
Errors <- read.csv("Data/Processed/IPF/IPF_errors.csv")
...
#### MSE ----
Diff_norm <- read.csv("Data/Processed/Dynamic_network_analysis/global_MSE.csv")
...
#### Mean strength ----
Strengths_mean_net <- read.csv("Data/Processed/Dynamic_network_analysis/mean_strength.csv")
...
##### Local strength ----
strength <- read.csv("Data/Processed/Dynamic_network_analysis/strength.csv")
...
df <- read.csv("Data/Processed/Dynamic_network_analysis/local_strength_function.csv")
...
#### Functional outliers ----
df <- read.csv("Data/Processed/Dynamic_network_analysis/functional_outliers.csv")
df$Week <- as.Date(df$Week)
df$Station <- as.factor(df$Station)
